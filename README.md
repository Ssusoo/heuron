...
![Temurin JDK](https://img.shields.io/badge/-Temurin_JDK_21-FFFFFF?logo=openjdk&logoColor=white&&style=flat)
...
- `record 객체`
    - Patient, PatientImage 도메인의 DTO 는 record 로 설계했습니다.
...
### 테스트 결과 (주요 도메인 로직 대상 코드 커버리지 83% 달성)
![테스트 Summary](./docs/test_summary.png)
![테스트 결과](./docs/test_results.png)

## Swagger
http://localhost:8080/heuron/swagger.html
